...
getwd()
setwd("C:/Users/91810/Desktop/RStudio files/Excel File Data")
getwd()

df_titanic <- read.csv(file = "C:/Users/91810/Desktop/RStudio files/Excel File Data/TitanicDataMissingValues.csv")
...
library(dplyr)
# na.omit() function work to delete the na values from corresponding rows
...
# Create mean
# %in% is use to retrieve the values from the right hand side using data
# na.rm=TRUE use to leave the no values rows while calculating the mean or median 
