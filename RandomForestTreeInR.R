...
#Read the data from set directory
data <- read.csv("heart-disease.csv",header=TRUE)
...
#we use confusion matrix to evaluate the performance of model:
